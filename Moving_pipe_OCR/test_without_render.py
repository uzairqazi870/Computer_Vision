...
ap.add_argument('-v', '--video', required=True, default="./Task_4_Moving_pipe_OCR.mp4", help='path to the video')
...
if __name__ == '__main__':
    ...
    out = cv2.VideoWriter('output.mp4', codec, vid_fps, (vid_width, vid_height))
